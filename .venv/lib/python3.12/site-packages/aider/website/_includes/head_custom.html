...
<meta
  ...
  content="{{ site.url }}{{ page.highlight_image }}"
/>
{% else %}
<meta property="og:image" content="{{ site.url }}/assets/aider.jpg" />
<meta
  property="twitter:image"
  content="{{ site.url }}/assets/aider-square.jpg"
/>
{% endif %}
<link
  rel="alternate"
...
<link
  ...
  type="image/png"
  sizes="32x32"
  href="{{ '/assets/icons/favicon-32x32.png' | relative_url }}"
/>
<link
  rel="icon"
  type="image/png"
...
<link
  rel="mask-icon"
  href="{{ '/assets/icons/safari-pinned-tab.svg' | relative_url }}"
  color="#5bbad5"
/>
