  ...
  <body class="indexfile">
    <header>
      <div class="content">
        ...
        <h2>
          ...
          <a
            class="button{% if ibtn.current %} current{% endif %}"
            {%
            if
            ibtn.url
            %}
      ...
      <table class="index" data-sortable>
        ...
        <tbody>
          ...
          <tr class="region">
            ...
            {% endif %}
            <td class="right" data-ratio="{{region.nums.ratio_covered|pair}}">
              {{region.nums.pc_covered_str}}%
            </td>
          </tr>
          {% endfor %}
        </tbody>
    ...
    <footer>
      ...
      <aside class="hidden">
        ...
        <button
          type="button"
          class="button_prev_file"
          data-shortcut="["
        ></button>
        <button
          type="button"
          class="button_next_file"
          data-shortcut="]"
        ></button>
        <button
          type="button"
